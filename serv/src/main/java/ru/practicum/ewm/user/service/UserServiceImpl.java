...
public class UserServiceImpl implements UserService {
    ...
    public List<UserDto> getAllUsers(List<Integer> ids, Integer from, Integer size) {
        List<User> users = userRepository.findUsersByIds(ids, PageRequest.of(from, size));
    ...
    public UserDto createUser(UserDto userDto) {
        ...
        return UserMapper.toUserDto(userRepository.findById(user.getId())
                .orElseThrow(() -> new NotFoundException("User was not save correctly!")));
    }
